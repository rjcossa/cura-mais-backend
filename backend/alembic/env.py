...
# `backend/` directory (the normal case) or elsewhere.
import os
import sys
...
# Import every module's models so they register their tables on
# Base.metadata before autogenerate/target_metadata is evaluated. As new
# modules (Providers, Pharmacy, ...) are added, import their models here
# too.
...
# (single source of truth — see backend/.env).
